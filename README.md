...
Matlab implementation of Elastic Principal Graphs (ElPiGraph) method. For the basic description of ElPiGraph, read https://github.com/auranic/Elastic-principal-graphs/blob/master/ElPiGraph_Methods.pdf. 
