...
NodePositions = load('.\test_data\hgdp_PC3.nodes');
Edges = load('.\test_data\hgdp_PC3.edges');
...
figure;
drawPieCharts(nodesMM,TaxonMap,labels,LabelColorMap,'ScaleCharts',0.8); drawGraph2D(nodesMM,Edges,'ShowClusterNumbers',0);