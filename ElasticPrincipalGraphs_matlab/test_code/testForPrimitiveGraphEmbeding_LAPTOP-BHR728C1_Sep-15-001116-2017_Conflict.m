...
ElasticMatrix = MakeUniformElasticMatrix(Edges,0.5,10);
...
[EmbeddedNodePositions,~,partition] = PrimitiveElasticGraphEmbedment(X, NodePositions, ElasticMatrix,'MaxNumberOfIterations',100,...
   'verbose',1,...
   'Local',struct('Nodes',NodeSubSet,'Partition',partition,'WeightedAverages',...
   NodeClusterCenters,'NodeClusterRelativeSizes',NodeClusterRelativeSize));
