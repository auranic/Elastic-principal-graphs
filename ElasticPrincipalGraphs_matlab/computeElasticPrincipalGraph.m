function [NodePositions,Edges,ReportTable,cpg,mml] = computeElasticPrincipalGraph(data,NumNodes,ParameterSet,varargin)
...
varargin{narg+1} = 'ParameterSet';
varargin{narg+2} = ParameterSet;
